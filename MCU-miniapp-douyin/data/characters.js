/* ============================================================
 * MCU 宇宙导航（小程序） - 角色数据（V1 骨架版）
 * ------------------------------------------------------------
 * 来源：H5 mcu-navigator/data/characters.js（唯一可信源，机械适配）
 * 适配方式：window.MCU_CHARACTERS = [ ... ] → module.exports（去 window 前缀）
...
module.exports = { CHARACTERS, CAMPS };
