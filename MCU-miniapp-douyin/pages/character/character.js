...
Page({
  ...
  onLoad: function (options) {
    ...
    tt.setNavigationBarTitle({ title: char.cn.split(' / ')[0] });
    this.setData({
      notFound: false,
      char: {
  ...
  goMovie: function (e) {
    tt.navigateTo({ url: '/pages/movie/movie?id=' + e.currentTarget.dataset.id });
  },

  goCharacter: function (e) {
    const id = e.currentTarget.dataset.id;
    tt.navigateTo({ url: '/pages/character/character?id=' + id });
  },
