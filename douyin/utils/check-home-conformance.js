/* ⚠ 本脚本已废弃（2026-09-08 标注，勿依赖其结果）
 * ------------------------------------------------------------
 * 校验对象是 V1.1 版首页结构（hasProgress 双态 / feat-cards / feat-title /
 * ring-num-b / phase-tag / tabs routes+explore+star）。该结构已被
 *   ① V1.2 视觉改版（Hero Banner + 旅程卡 + 推荐卡）
 *   ② 2026-09-07 抖音合规整改（移除资讯型模块，TabBar 收敛为 2→ 现 3 项）
 * 两轮重构取代，因此 15 项断言全部为「结构性过时」而非代码缺陷。
 * 已验证：对 HEAD 基线版本运行本脚本，结果同为 CONFORMANCE_FAIL (15)。
 *
 * 现行替代：utils/smoke-tool-features.js
 *   → 覆盖作品查询 / 作品详情 / 已看 / 收藏 / 跨页联动 / 持久化 / 死链 / 页面可加载
 * 保留本文件仅为留档，后续如有新的首页结构门禁需求请新建脚本。
 * ============================================================ */
