 ...
 * MCU 宇宙导航（小程序） - 关系数据
 * ------------------------------------------------------------
 * 来源：H5 mcu-navigator/data/relations.js（唯一可信源，机械适配）
 * 适配方式：window.MCU_RELATIONS = [ ... ] → module.exports（去 window 前缀）
 * 数据内容 100% 一致，仅改变加载方式。禁止修改关系逻辑与数据。
 *
 * 产品铁律：不能只告诉用户「A 和 B 有关」，必须说清「A 为什么和 B 有关」。
...
module.exports = { RELATIONS, REL_TYPES };
